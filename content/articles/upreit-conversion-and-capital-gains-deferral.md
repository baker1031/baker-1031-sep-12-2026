---
source_url: https://baker1031.com/learn/upreit-conversion-and-capital-gains-deferral/
source_sha256: c78485d94d582f0217ef4940ffa24d28a967a40fabde5a188ddd076e84b26b47
writer: writer-c
draft_version: 1
...
I have been thinking about how easily a pre-tax value can be mistaken for spendable wealth. First-order thinking sees the tax avoided at contribution. Second-order thinking sees the same embedded gain carried into OP units, the triggers that can recognize it, and the value of preserving flexibility when tax and liquidity needs eventually collide.

The central tax benefit of an UPREIT conversion (721 exchange) is capital gains deferral — Section 721 defers the four-layer tax on your property, carrying the gain into your OP units. This guide explains how the deferral works, the capital gains you're deferring, the carryover basis, how long the deferral lasts, when it's triggered, and how the step-up can eliminate it.
...
- **Capital Gains Deferral:** Postponing the capital gains tax via the UPREIT conversion.

- **Section 721:** The provision deferring the gain on contributing property for units.

- **Four-Layer Tax Stack:** Capital gains, recapture, NIIT, and state tax — all deferred.

- **Carryover Basis:** The low basis carried into the units, embedding the deferred gain.

- **Deferred Gain:** The untaxed gain carried in the OP units.

- **Triggering Event:** A taxable disposition (conversion) recognizing the gain.
...
- **Indefinite Deferral:** The deferral lasting as long as you hold the units.

- **Depreciation Recapture:** A deferred layer (up to 25%), triggered on conversion.

- **Net Investment Income Tax:** The 3.8% deferred layer.

- **Compounding:** The benefit of the full deferred capital working over time.

- **Built-In Gain:** The deferred gain that a partnership sale could trigger.

- **Tax Protection:** An agreement shielding the gain from a partnership-sale trigger.

- **Permanent Elimination:** The deferral becoming tax-free via the step-up.

- **Low Basis:** A small basis (large gain) making the deferral valuable.
...
For capital, I would treat tax deferral as a way to retain invested value while accepting that the basis, conversion choice, liquidity, and estate plan must work together. What part of that tradeoff are you weighing most carefully?
