---
source_url: https://baker1031.com/learn/dst-vs-selling-and-paying-tax-the-math/
source_sha256: cf50822a182ae11d16431826e966da65792ff84812d259fc1af4489c49edce08
writer: writer-a
draft_version: 1
...
[Home](baker1031.html) › Insights › DST vs. Selling and Paying Tax: The Math

[Back to All Insights](insights.html)

**Delaware Statutory Trusts Baker 1031 Research  ·  Updated June 2026  ·  16 min read**

I keep coming back to the number that disappears between a sale contract and a reinvestment plan. It is easy to focus on the gross price; the capital available after tax is the number that actually gets allocated.

First-order thinking asks whether deferral postpones a tax bill. Second-order thinking asks what the retained equity can do over time, what liquidity and fees cost, and whether keeping capital in real estate still serves the investor.
...
Two further layers often surprise sellers. [Depreciation recapture](depreciation-recapture-real-estate.html) applies to the depreciation you deducted over your holding period: that portion of the gain is taxed as 'unrecaptured Section 1250 gain' at a federal rate of up to 25%, regardless of your ordinary bracket. And the 3.8% [net investment income tax](net-investment-income-tax.html) (NIIT) can apply to investment gains for higher-income taxpayers. Stack federal capital gains, state tax, recapture, and NIIT together, and a meaningful share of your gain — in some cases a quarter to a third or more — can go to tax, leaving you less capital to reinvest.
...
**1031 Exchange** — A like-kind exchange that defers tax on investment real estate.

**Delaware Statutory Trust (DST)** — 1031-eligible fractional interest in income-producing real estate.

**Capital-Gains Tax** — Federal tax on appreciation, generally 0%, 15%, or 20%.
...
**State Income Tax** — A state's own tax on the gain where applicable.

**Cost Basis** — Your investment in the property, used to figure gain.

**Adjusted Basis** — Cost basis reduced by depreciation and adjusted by improvements.

**Tax Deferral** — Postponing tax by exchanging rather than selling outright.

**Boot** — Cash or non-like-kind value taken in an exchange, taxable.

**Qualified Intermediary (QI)** — The party that holds proceeds to keep a 1031 valid.

**Step-Up in Basis (§1014)** — Basis reset at death that can erase deferred gain.

**Pass-Through Depreciation** — Depreciation a DST passes to investors, sheltering income.

**Distribution Rate** — Projected income as a percentage of invested equity.
...
## DST deferral vs. paying the tax at a glance

How exchanging into a DST compares with selling outright and paying the tax, across the factors that drive the math:

<table class="dtable2">
<thead><tr><th>Factor</th><th>DST (Defer)</th><th>Sell &amp; Pay Tax</th></tr></thead>
<tbody>
<tr><td>Tax at sale</td><td>Deferred under §1031</td><td>Due now — gains, recapture, NIIT, state</td></tr>
<tr><td>Capital reinvested</td><td>Full pre-tax proceeds</td><td>After-tax remainder only</td></tr>
<tr><td>Income base</td><td>Distributions on the larger amount</td><td>Distributions on the smaller amount</td></tr>
<tr><td>Compounding</td><td>Deferral compounds over the hold</td><td>Diminished by the up-front tax</td></tr>
<tr><td>Estate planning</td><td>Step-up at death may erase deferred gain</td><td>No deferred gain remains</td></tr>
<tr><td>Flexibility</td><td>Must stay in like-kind real estate</td><td>Free to use the cash anywhere</td></tr>
<tr><td>Best when</td><td>You want real estate income to continue</td><td>You want to exit real estate</td></tr>
</tbody>
</table>

## Which should you choose?

The DST wins on the math when you intend to keep earning real estate income, because deferring the tax keeps the full pre-tax amount generating distributions and compounding — and a step-up at death can erase the deferred gain for heirs.

Selling and paying the tax can still make sense when you want to exit real estate, need the cash elsewhere, or your gain is small enough that deferral adds little. Run your own numbers with your CPA before deciding.
...
I would start by reserving the cash that has a near-term job, then run the actual sale and exchange figures with a CPA before treating tax deferral as a benefit. The larger pool of invested capital matters only when the structure, illiquidity, fees, and real-estate exposure fit the plan. How are you weighing liquidity today against the value of keeping more equity working?
