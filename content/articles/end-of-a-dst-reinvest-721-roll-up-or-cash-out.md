---
source_url: https://baker1031.com/learn/end-of-a-dst-reinvest-721-roll-up-or-cash-out/
source_sha256: 5275bac04ef5c2e472cfd6390d79aab1bf54fdf177ec807ada2f193a7c05ed28
...
[Home](baker1031.html) › Insights › End of a DST: Reinvest, 721 Roll-Up, or Cash Out
...
The [definitive DST guide](dst-guide.html) explains the lifecycle behind this moment. The essential point is simple: when the DST sells, the trust dissolves, the deferred gain comes back into play, and deferral continues only if the investor acts.
...
The second choice is a 721 roll-up, also called an UPREIT transaction. Rather than exchange into another property, the investor contributes the DST interest or proceeds to a REIT operating partnership for [OP units](op-units-explained.html). Section 721 can make this contribution tax-deferred. Many DSTs are designed from the outset for an affiliated REIT to acquire the property at full cycle and offer this path.
...
The third choice is to take the proceeds and pay the deferred tax. The investor does not reinvest through a 1031 or a 721. Capital-gains tax deferred through the DST, plus potential [depreciation recapture](depreciation-recapture-real-estate.html) and applicable [net investment income tax](net-investment-income-tax.html), comes due in that tax year. After payment, the remaining proceeds are free for any use, with no exchange obligation or illiquid commitment.
