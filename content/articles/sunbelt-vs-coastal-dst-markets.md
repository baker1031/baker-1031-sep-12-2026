---
source_url: https://baker1031.com/learn/sunbelt-vs-coastal-dst-markets/
source_sha256: 43e24dc770003417773412525f987042036187af7ded5a1fabac63e7141518bc
writer: writer-c
draft_version: 1
...
I keep coming back to the map before I look at the yield. First-order thinking sees a Sunbelt label or a coastal label and expects an answer. Second-order thinking asks what supply, price, leverage, sponsor execution, and tenancy leave for an investor after the cycle turns.

Sunbelt and coastal markets offer different risk-and-return profiles for DST real estate. This guide compares Sunbelt growth patterns, coastal market stability, the demographic and job trends behind them, how to balance growth and stability, and how to allocate across geographies using multiple DSTs.
...
**Sunbelt Markets:** Fast-growing southern and southwestern markets like Texas, Florida, Arizona, and Georgia.

**Coastal / Gateway Markets:** Established, supply-constrained metros like coastal California, New York, and Boston.

**Supply-Constrained:** A market where limited land and regulation restrict new construction, supporting values.

**In-Migration:** Population moving into a market, driving real estate demand.

**New Supply:** New construction that can pressure rents and occupancy in growth markets.

**Diversified DST Portfolio:** DST holdings spread across markets, sectors, and sponsors to reduce risk.

**Geographic Allocation:** Spreading capital across different markets to balance growth and stability.

**Growth vs. Stability:** The core trade-off between Sunbelt growth potential and coastal steadiness.
...
**Like-Kind Property:** U.S. investment real estate, broadly interchangeable across states and markets.

**45-Day / 180-Day Rules:** The 1031 deadlines to identify and complete an exchange.

**Identification Rules:** The 1031 rules (three-property, 200%) limiting replacement identifications.
...
## Sunbelt vs. coastal DST markets at a glance

How Sunbelt and coastal markets compare for DST real estate across growth, stability, and risk:

| Factor | Sunbelt Markets | Coastal Markets |
| --- | --- | --- |
| Population & jobs | Faster in-migration and job growth | Slower but established demand |
| Supply | More new construction | More supply-constrained |
| Rent patterns | Growth-driven, can be cyclical | Steadier, established rents |
| Return emphasis | Appreciation and growth | Stability and durable income |
| Primary risk | Overbuilding in hot submarkets | Slower growth, higher entry pricing |
| Investor fit | Growth-oriented allocations | Stability-oriented allocations |

## Which should you choose?

Sunbelt markets emphasize growth, driven by population in-migration and job creation, with the trade-off of cyclicality and overbuilding risk in the hottest submarkets. Coastal markets emphasize stability and durable income, with supply constraints supporting rents but slower growth and higher entry pricing.

Rather than pick one, many DST investors allocate across both geographies — pairing Sunbelt growth with coastal stability — to balance appreciation potential against income durability.
