---
source_url: https://baker1031.com/learn/dst-full-cycle/
source_sha256: f783914dd2ce1d8db2d06250983f3c39d5cd45b0641c5d25a046b70c8f69a2c5
writer: writer-a
draft_version: 1
...
Delaware Statutory Trust Baker 1031 Research · Updated June 2026 · 16 min read

I keep seeing a DST’s purchase decision analyzed without enough attention to its eventual sale. First-order thinking asks whether the current income and property fit. Second-order thinking asks what happens when the sponsor sells, when the 1031 clock returns, and whether cash, a new exchange, or a 721 transition is acceptable before investing.
...
The full-cycle event is the final chapter of the lifecycle described in [our in-depth DST pillar guide](dst-guide.html).
...
If you want to keep deferring, you can roll the proceeds into a new [1031 exchange](1031-exchange-guide.html) — into a directly owned property, or into another DST. This continues the deferral indefinitely and resets the cycle, subject once more to the familiar 45-day identification and 180-day closing [deadlines](1031-exchange-timeline.html). Many long-term DST investors simply chain offerings this way, moving from one full-cycle program into the next and preserving the deferral across decades. The discipline required is the same as any exchange: have your next move identified and ready, because the clock starts when the DST sells.
...
- Cornell Legal Information Institute. [26 U.S. Code § 721 — Nonrecognition of gain or loss on contribution to a partnership](https://www.law.cornell.edu/uscode/text/26/721)

- Baker 1031. [Baker 1031 DST Data Center — full-cycle and offering performance data](insights.html)
...
For capital, I would set the full-cycle plan before the first DST purchase and revisit it as a sale approaches, keeping tax, liquidity, estate, and reinvestment needs in view. Which full-cycle option best fits your current objective?
