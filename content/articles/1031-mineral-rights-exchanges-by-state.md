---
source_url: https://baker1031.com/learn/1031-mineral-rights-exchanges-by-state/
source_sha256: a958fde568bba33a841f9940ae357a2ab115a3b99e5a73b5209c539f9c83c5ab
writer: writer-b
draft_version: 1
source_unit_count: 138
...
I keep seeing a 1031 exchange described as if the federal rulebook settles the whole question. It does not. Where the minerals sit can change the instrument you need, the tax layers you defer, and the state exposure that remains after closing.

First-order thinking stops at the federal deferral. Second-order thinking traces the ownership record, the applicable state property law, the owner’s residence, the replacement’s location, and any clawback rule that may still matter years later.
...
The federal rules these state nuances sit on top of are covered in [our comprehensive mineral rights and royalty 1031 guide](mineral-rights-1031-guide.html).
...
The no-income-tax feature also affects cross-state planning. A Texas owner exchanging into real estate or minerals in an income-tax state may pick up state tax exposure on that new asset's future income or sale, and an owner moving from an income-tax state into Texas minerals may reduce theirs. These cross-state tax effects are worth modeling with a CPA. For a Texas owner staying within Texas, though, the exchange is about deferring the federal stack, with the welcome absence of a state income-tax layer simplifying the picture.
...
2. California Franchise Tax Board. [Like-Kind Exchanges (FTB 3840) — California clawback reporting](https://www.ftb.ca.gov/forms/2024/2024-3840.pdf)
3. U.S. Energy Information Administration. [Crude Oil Production by State](https://www.eia.gov/petroleum/)
...
My current posture is to treat state analysis as part of the investment decision before the sale closes: confirm the title, map every relevant jurisdiction with a CPA, and reserve optimism for what survives that work. What state-specific issue is most important in the mineral exchange you are considering?
