---
source_url: https://baker1031.com/learn/dst-to-reit-via-721-exchange-two-step-strategy/
source_sha256: 878954c5af1d1678438dd99603b6e916e62f898992c53ef994c8cf95cc309ccc
writer: writer-b
draft_version: 1
...
# DST-to-REIT via 721 Exchange: The Two-Step Strategy
...
I keep seeing investors treat a tax-deferred first step as if it assures the rest of the journey. First-order thinking sees a 1031 into a DST and a later 721 as a straight line to REIT ownership. Second-order thinking sees a sequence: the first step has statutory deadlines, while the later exit depends on the offering structure, the sponsor, and an investor's ability to accept liquidity and tax tradeoffs.

The DST-to-REIT strategy is a two-step path that combines a 1031 exchange (into a Delaware Statutory Trust) with a later 721 exchange (into a REIT's operating partnership) — letting an investor reach diversified, liquid REIT ownership entirely tax-deferred. This guide explains the two steps, why combine them, what to confirm before investing, and the tax treatment across both steps.
...
The DST-to-REIT strategy combines two tax-deferred steps into a path from direct property to REIT ownership. Step one is a 1031 exchange into a DST: the investor sells their property and exchanges into a [Delaware Statutory Trust](dst-guide.html), deferring the gain under Section 1031 and gaining a passive, fractional interest in the DST's real estate. Step two is a 721 exchange into a REIT: later, the REIT acquires the DST's property (or the DST is otherwise UPREIT'd), and the investor's DST interest is converted into operating partnership (OP) units in the REIT, under Section 721.
...
- **DST-to-REIT Strategy:** The two-step path: 1031 into a DST, then 721 into a REIT.

- **Two-Step Strategy:** Combining a 1031 (into a DST) and a 721 (into a REIT).

- **1031-then-721:** Another name for the DST-to-REIT two-step strategy.

- **Delaware Statutory Trust (DST):** The passive 1031 vehicle that bridges to the REIT.

- **721/UPREIT Exit:** The REIT acquiring the DST and converting interests to OP units.

- **Step One:** The 1031 exchange into a DST, deferring under Section 1031.

- **Step Two:** The 721 exchange into the REIT, deferring under Section 721.
...
- **Section 1031:** The provision deferring gain in step one (into the DST).

- **Section 721:** The provision deferring gain in step two (into the REIT).

- **Bridge:** The DST's role connecting your property to the REIT.

- **Exit Timing:** When the 721 exit occurs, not always fixed or guaranteed.

- **Traded vs Non-Traded REIT:** Whether the eventual REIT's shares are exchange-listed (liquidity).

- **Step-Up in Basis:** The death-time reset available on the eventual OP units.
...
For capital, I would move carefully through the 1031 deadlines, confirm the terms of any possible 721 exit before investing, and treat the path to REIT units as conditional rather than automatic. Where do the timing and liquidity constraints matter most in your own planning?
