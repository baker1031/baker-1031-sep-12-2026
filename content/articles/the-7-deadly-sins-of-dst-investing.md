...
Ignoring the fee load — focusing on projected returns without understanding the upfront load (commissions, offering costs, acquisition fees) and ongoing fees (asset-management, property-management, disposition) that reduce capital deployed and cash distributed — is a costly mistake. The lesson is to evaluate returns net of all fees, read the disclosures, and compare fee structures across sponsors alongside property quality and price-to-value. Fees aren't disqualifying, but they must be seen. Clear-eyed fee analysis protects your return. Don't ignore the fee load: understand the upfront and ongoing fees, judge returns net of fees, and compare across sponsors, since fees quietly shape what you actually keep.
