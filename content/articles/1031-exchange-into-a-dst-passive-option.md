---
source_url: https://baker1031.com/learn/1031-exchange-into-a-dst-passive-option/
source_sha256: 0aebaab30c8c2d7a2e401ba4b65a9ab3ddf542fb27cf6505ac48afc0aa6f276f
writer: writer-c
draft_version: 1
source_unit_count: 195
...
I keep seeing the speed of a DST closing become the whole decision. First-order thinking says a passive replacement can solve a 45/180-day deadline and debt-replacement constraint. Second-order thinking asks whether the investor can accept the security's illiquidity, fixed structure, fees, and full-cycle exit before the clock makes the decision feel urgent.
...
You exchange into a DST through a [qualified intermediary](what-is-a-qualified-intermediary.html) like any 1031: the QI holds your proceeds and uses them to acquire your DST interest within the deadlines.
...
This solves one of the trickiest parts of a 1031: [replacing debt to avoid mortgage boot](1031-exchange-debt-replacement-mortgage-boot.html). By choosing a DST whose loan-to-value matches your old debt, you replace the leverage automatically. DSTs also come in debt-free versions for exchangers who had no debt to replace.
...
DSTs are designed to be held for the trust's full life cycle, typically several years (often around 5–10), at the end of which the property is sold (["full cycle"](dst-full-cycle.html)) and capital and gain are returned to investors. You generally can't exit a DST early, since the secondary market is limited.

At full cycle, investors typically have a choice: take the proceeds (a taxable event unless they do another 1031 exchange) or, increasingly, [roll into the sponsor's REIT](from-dst-to-reit-721-rollup.html) via a [721 UPREIT exchange](721-exchange-guide.html). Understanding the projected hold and exit before investing is important, since both become part of your outcome.
...
This can be attractive: gain stays deferred, the investor moves from a single asset into a diversified REIT, and [OP units](op-units-explained.html) offer a path to staged liquidity (converting to REIT shares over time). But it's also a one-way door: once in OP units, you generally can't 1031 back into direct real estate.
...
Evaluate the property or portfolio: the asset quality, location, tenant base, lease terms, leverage (LTV), and the projected distributions and their durability. Read the [private placement memorandum](how-to-review-a-ppm.html) (PPM) and its risk factors carefully — that's where the real diligence begins.
...
DSTs are speculative, illiquid securities sold only to [accredited investor](accredited-investor-requirements.html)s via a private placement memorandum, and they carry substantial risk. The main risks include illiquidity (you hold for the full cycle), no control (the sponsor decides everything), fees and load (which reduce returns), and the static structure (the trust can't reposition the property).
...
- Baker 1031 Investments. [Delaware Statutory Trusts strategy](delaware-statutory-trusts.html)

- Baker 1031 Investments. [What is a DST? (Learning Center)](dst-guide.html)

- IRS. [Like-Kind Exchanges — qualifying property](https://www.irs.gov/newsroom/the-treasury-department-and-irs-issue-final-regulations-regarding-like-kind-exchanges-of-real-property)

- IPX1031. [DSTs as replacement property](https://www.irs.gov/forms-pubs/about-form-8824)

## Disclosures

This article is published by Baker 1031 Investments, LLC for general educational purposes for accredited investors and is not an offer to sell or a solicitation of an offer to buy any security, nor is it tax, legal, accounting, or investment advice or a recommendation. Any securities offering is made solely through a sponsor’s private placement memorandum (PPM) following a suitability determination. Securities offered through Aurora Securities, Inc. (ASI), member FINRA / SIPC; Baker 1031 Investments is independent of ASI.

Filed under [1031 Exchange](insights.html) [DSTs](delaware-statutory-trusts.html)
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "1031 Exchange Into a DST: The Passive Option",
  "description": "A DST lets 1031 investors own institutional real estate passively, close in days, and replace debt without a new loan. How DSTs qualify, the risks, and exits.",
  "dateModified": "2026-06-01",
  "author": {"@type": "Organization", "name": "Baker 1031 Investments"},
  "publisher": {
"@type": "Organization",
...
{"@type": "ListItem", "position": 3, "name": "1031 Exchange Into a DST: The Passive Option"}
  ]
}
</script>

For capital, I would use a DST when passive ownership, timing, debt replacement, and suitability line up—and hold back when liquidity or control carries more value. Which tradeoff is driving your 1031 decision?
