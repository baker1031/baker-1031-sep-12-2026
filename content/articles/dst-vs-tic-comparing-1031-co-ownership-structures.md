---
source_url: https://baker1031.com/learn/dst-vs-tic-comparing-1031-co-ownership-structures/
source_sha256: 6daca339a706c02a88de2e2de8829da1d5dc4c708a268402d244d02d36c0e75d
writer: writer-a
draft_version: 1
...
[Home](baker1031.html) › Insights › DST vs. TIC: Comparing 1031 Co-Ownership Structures

[Back to All Insights](insights.html)

**Delaware Statutory Trusts Baker 1031 Research  ·  Updated June 2026  ·  16 min read**

I keep seeing co-ownership framed as a choice between two labels. The more useful question is what each label asks the investor to give up: control, flexibility, coordination, or simplicity.

First-order thinking treats a DST and a TIC as interchangeable ways to complete a 1031 exchange. Second-order thinking follows the loan, voting rights, investor count, liquidity, and the decisions that become difficult when conditions change.
...
Next, weigh investor scale and minimums: DSTs accommodate many investors at lower minimums and let you diversify a single exchange across several offerings, while TICs cap at 35 co-owners with larger per-investor stakes. Finally, factor in coordination and timing: a [1031 exchange](1031-exchange-guide.html) runs on tight 45- and 180-day clocks, and a DST — pre-packaged, pre-financed, and ready to close quickly — is often easier to use within those deadlines than assembling a TIC group and arranging fragmented financing. For most passive 1031 investors today, the DST wins on financing, scale, and speed; the TIC wins narrowly on control and refinancing flexibility.
...
**Delaware Statutory Trust (DST)** — A trust that owns real estate; investors hold fractional beneficial interests.

**Tenancy-in-Common (TIC)** — Direct, deeded fractional co-ownership of a property.

**Beneficial Interest** — A DST investor's fractional stake in the property-owning trust.

**Undivided Interest** — A TIC co-owner's deeded fractional share of the whole property.

**Rev. Rul. 2004-86** — The IRS ruling making DST interests 1031-eligible real property.

**Rev. Proc. 2002-22** — IRS guidance that set the 35-co-owner cap for 1031 TICs.

**Single Borrower** — The DST trust itself as the sole borrower on one loan.

**Separate Borrower** — Each TIC co-owner treated individually on the loan.

**Bankruptcy-Remote** — Structured so an investor's trouble can't reach the property or loan.

**Non-Recourse Loan** — Debt secured only by the property, not the investor personally.

**Unanimous Consent** — The TIC requirement that all co-owners agree on major decisions.

**Trustee** — The party who operates a DST within strict limits; investors don't vote.

**Debt Replacement** — Matching the relinquished property's debt in the replacement property.

**Cash-Out Refinance** — Pulling equity out via new debt — permitted in a TIC, barred in a DST.

**Seven Deadly Sins** — The DST restrictions (no new debt, no refinancing, etc.) behind Rev. Rul. 2004-86.
...
## DST vs. TIC at a glance

How the two fractional 1031 co-ownership structures compare on the points that drive most decisions:

<table class="dtable2">
<thead><tr><th>Factor</th><th>DST</th><th>TIC (Tenants-in-Common)</th></tr></thead>
<tbody>
<tr><td>1031 eligible</td><td>Yes</td><td>Yes</td></tr>
<tr><td>Number of investors</td><td>Effectively unlimited beneficial owners</td><td>Capped (historically up to 35)</td></tr>
<tr><td>Decision-making</td><td>None required; sponsor/trustee decides by rule</td><td>Each co-owner typically must consent to major decisions</td></tr>
<tr><td>Financing</td><td>Single trust-level loan; investor is not on the note</td><td>Each owner is generally on title and the loan</td></tr>
<tr><td>Minimums</td><td>Often $25K–$100K</td><td>Usually much higher per co-owner</td></tr>
<tr><td>Management</td><td>Fully passive</td><td>Passive but with co-owner coordination</td></tr>
<tr><td>Prevalence today</td><td>The dominant structure post-Rev. Rul. 2004-86</td><td>Niche; used in specific situations</td></tr>
</tbody>
</table>

## Which should you choose?

For most passive 1031 investors the DST is the simpler structure: no co-owner consent, no personal loan exposure, and lower minimums make it easier to fully deploy exchange proceeds inside the 45/180-day windows.

A TIC can still make sense when investors want direct title, a say in major decisions, or a structure that supports a later transaction the DST's static rules would not permit. Match the structure to how much control and coordination you actually want.
...
I would choose the structure only after matching the desired control, debt exposure, time horizon, and exchange deadline to the actual documents. A clean closing is not enough if the ownership structure makes the next decision harder. How are you weighing direct control against the simplicity of a centralized structure?
