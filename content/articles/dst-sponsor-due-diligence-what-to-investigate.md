---
source_url: "https://baker1031.com/learn/dst-sponsor-due-diligence-what-to-investigate/"
source_sha256: "63cb2431ecf2d7e17225631c1983be7c763c29cb05db32b6cba98d9d9e1cb0f0"
writer: "writer-c"
draft_version: 1
...
# DST Sponsor Due Diligence: What to Investigate
...
I have been thinking about the gap between a polished offering presentation and the documents that have to support it. The gap is where diligence earns its keep.

Before committing 1031 proceeds to a DST, thorough due diligence on the sponsor and offering is essential. This guide walks through what to investigate — reviewing prior offering performance, assessing sponsor financial strength, conducting property-level diligence, reading the private placement memorandum, and seeking independent third-party analysis.

First-order thinking accepts the headline case. Second-order thinking tests the sponsor, property, debt, disclosures, tax fit, and independent evidence that could make the headline case fail.
...
Sponsor quality is one of the themes we return to throughout [our 2026 DST guide](dst-guide.html).
...
So it's the safeguard that completes thorough due diligence. Independent third-party analysis — the broker-dealer's own due diligence, third-party due-diligence reports, your own attorney and CPA reviewing the PPM and tax aspects, and independent market, property, and tenant data — provides an objective check on the sponsor's favorable presentation, letting you triangulate the sponsor's claims against sources that don't profit from your investment. Seek it out. Independent third-party analysis — broker-dealer diligence, third-party reports, your own attorney and CPA, and independent market data — gives an objective check on the sponsor's claims, completing thorough due diligence.
...
**Due Diligence**: The research process of investigating a DST sponsor and offering.

**Prior Offering Performance**: How a sponsor's past deals performed (realized vs. projected).

**Realized vs. Projected**: Comparing actual full-cycle results to original forecasts.

**Sponsor Financial Strength**: A sponsor's capitalization and ability to weather downturns.

**Property-Level Diligence**: Investigating the market, asset, tenants, leases, and debt.
...
**Private Placement Memorandum (PPM)**: The central disclosure document for a DST offering.

**Risk Factors**: The PPM section cataloging what could go wrong.

**Conflicts of Interest**: Where a sponsor's interests may diverge from investors'.

**Revenue Ruling 2004-86**: The IRS ruling making a DST interest 1031-eligible real property.

**Independent Third-Party Analysis**: Objective evaluation from sources outside the sponsor.

**Broker-Dealer Diligence**: The independent review a broker-dealer performs on an offering.

**Suitability Review**: Confirming a DST fits the investor's profile and accreditation.
...
For now, I would treat a missing document, an unsupported projection, or an unanswered question as a reason to slow down before committing 1031 capital. What is the first item you would test before relying on a DST sponsor's presentation? If you are working through this now, write to me and we can go through it.
