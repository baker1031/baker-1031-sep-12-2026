---
source_url: https://baker1031.com/learn/history-of-the-1031-exchange/
source_sha256: 8106da08098956f02794307a7fa4a9f3439cd8c30a7bbaaf15eb35e456930e23
writer: writer-c
draft_version: 1
...
After Starker established that deferred exchanges could qualify, Congress added structure. The Deficit Reduction Act of 1984 codified the deferred exchange and imposed the time limits that still govern it: the [45-day identification period](1031-exchange-identification-rules.html) for naming replacement property and the 180-day period for completing the acquisition. They remain core [1031 exchange rules](1031-exchange-rules-requirements.html).
...
Deadlines did not solve every practical problem. An investor who constructively receives sale proceeds can disqualify the exchange. Treasury's comprehensive regulations, finalized in 1991, created safe harbors to address that issue. The most important is the [qualified intermediary](what-is-a-qualified-intermediary.html), or QI, safe harbor.
...
The exchange is widely used to reinvest, move into larger properties, diversify, change markets, or pursue passive structures such as DSTs. DST interests were recognized as exchangeable real property interests in IRS guidance from 2004. For a process overview, see the [primer for first-time exchangers](1031-exchange-basics-first-time-investors.html).
...
See the [1031 Exchanges currently available](1031-exchanges.html) and how they may fit a strategy like this one. Educational only — not an offer of any security. Offerings are available to verified, accredited investors and change over time.
