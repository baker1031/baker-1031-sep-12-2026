---
source_url: "https://baker1031.com/learn/simultaneous-1031-exchange-explained/"
source_sha256: "8d51c4f0b207ee905f041fac932a5cd9e804a1f321121a840910797e23cc2456"
...
# Simultaneous 1031 Exchange Explained

[Back to All Insights](insights.html)

1031 Exchange · Baker 1031 Research · Updated June 2026 · 16 min read

I keep seeing how much attention a 1031 exchange calendar attracts—and how little attention goes to the simple question underneath it: did the taxpayer ever control the proceeds?

Before delayed exchanges made 1031s practical, the simultaneous exchange was the standard—and original—form: the relinquished-property sale and replacement-property purchase closed at the same time in one coordinated transaction. Today it is rare because the delayed exchange removed the need to synchronize two real-estate closings perfectly. Still, the structure matters for completeness, for the occasional situation where it is used, and because it shows why the delayed exchange and the qualified intermediary became central. This article explains what a simultaneous exchange is, why it is uncommon, the coordination challenges, the risk of proceeding without a qualified intermediary, and the limited situations in which it still appears.

First-order thinking treats a simultaneous exchange as the cleanest possible swap because there is no gap between the two closings. Second-order thinking focuses on what must be synchronized, who controls the funds at every moment, and how a seemingly small timing or documentation failure can change the result. The lack of a gap does not eliminate execution risk.

## What a simultaneous exchange is

A simultaneous exchange is a [1031 exchange](1031-exchange-guide.html) in which the relinquished property and the replacement property close on the same day — the sale and the purchase happen concurrently rather than separated in time. In its simplest form, a two-party swap, two owners trade properties directly: you give your property to another party and receive theirs in return, simultaneously. More commonly in practice, simultaneous exchanges involve more parties — a three- or four-party arrangement where intermediaries or accommodators facilitate the concurrent transfers.
...
- Cornell Legal Information Institute. [26 CFR § 1.1031(k)-1 — Treatment of deferred exchanges (safe harbors)](https://www.law.cornell.edu/cfr/text/26/1.1031(k)-1)
- Cornell Legal Information Institute. [26 CFR § 1.1031(b)-2 — Safe harbor for qualified intermediaries](https://www.law.cornell.edu/cfr/text/26/1.1031(b)-2)
...
For capital, I would not let the elegance of a same-day swap outweigh safe-harbor protection, careful coordination, and the legal and tax review the structure requires. How are you thinking about certainty versus convenience in an exchange?
