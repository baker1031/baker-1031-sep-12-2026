---
title: "REITs"
seo_title: "REITs | Baker 1031 Investments"
source_url: "https://baker1031.com/learn/reits/"
source_sha256: "5630ff316d23648ea452444c853a84625d202d199d25a221ddf4a73a1a177a19"
writer: "writer-c"
draft_version: "1"
...
Strategy Baker 1031 Research &middot; Updated June 2026

I keep seeing investors treat a REIT label as an answer instead of the beginning of a set of questions. The label can describe a useful structure. It does not settle how the portfolio is valued, how it can be sold, or how it will behave when capital becomes scarce.
...
First-order thinking sees the 90% distribution rule and assumes income is the whole decision. Second-order thinking asks what the investor is giving up or gaining in control, liquidity, valuation transparency, and tax treatment. The structure matters as much as the dividend.

## How it works

### 01 — A REIT assembles a portfolio

The REIT acquires and manages income-producing properties across sectors and markets.

### 02 — It distributes 90%+ of income

To keep its tax status, the REIT pays out most taxable income as dividends to shareholders.

### 03 — You hold shares or OP units
...
| --- | --- |
| Direct property | Most control · illiquid · 1031-eligible |
| DST interest | Passive · illiquid (~5–10 yr) · 1031-eligible |
| Non-traded REIT | Diversified · periodic liquidity · 721 intake |
| Public REIT | Diversified · daily liquidity · a security |
...
<table>
<caption>Public REITs vs. non-traded REITs</caption>
<thead><tr><th scope="col">Feature</th><th scope="col">Public REIT</th><th scope="col">Non-traded REIT</th></tr></thead>
<tbody><tr><th scope="row">Liquidity</th><td>Daily on an exchange</td><td>Periodic, limited redemptions</td></tr><tr><th scope="row">Price volatility</th><td>Higher (market-driven)</td><td>Lower (NAV-based)</td></tr><tr><th scope="row">Minimums</th><td>One share</td><td>Typically $1K–$25K+</td></tr><tr><th scope="row">721 UPREIT intake</th><td>Rare</td><td>Common</td></tr><tr><th scope="row">Valuation</th><td>Live market price</td><td>Periodic NAV</td></tr><tr><th scope="row">Best for</th><td>Liquidity &amp; trading</td><td>Income &amp; 721 roll-ups</td></tr></tbody>
</table>

General comparison; specific REITs vary. Not investment advice.

I would manage capital by matching the structure to the liquidity I may actually need, rather than letting a stated yield or daily quote decide the allocation. What trade-off between control, diversification, and liquidity matters most to you?
