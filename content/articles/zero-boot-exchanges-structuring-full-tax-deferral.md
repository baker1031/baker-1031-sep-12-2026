---
source_url: "https://baker1031.com/learn/zero-boot-exchanges-structuring-full-tax-deferral/"
source_sha256: "6f8b9f970e6bd95d954874dbee1b927ae6a69ac6d87fd3dd220ca754cbdb1b8e"
...
For a zero-boot outcome, all net proceeds go into replacement property and the debt on the relinquished property is replaced, or any debt reduction is offset with additional cash. When both conditions are met, no cash or net debt relief is treated as boot. That is the standard objective for an investor seeking complete deferral. A partial exchange can be intentional—an investor may choose liquidity and accept tax on the boot—but it is a different objective. [Boot](what-is-boot-1031-exchange-how-to-avoid.html) and a [partial exchange, where some boot is intentionally taken](partial-1031-exchange-taking-cash-out.html) are useful related concepts.
...
The cure is either new replacement debt at least equal to the old debt or an added cash contribution equal to the reduction. If debt falls by **$100,000** and the investor adds **$100,000** of cash to the replacement, the cash offsets the debt relief. Investors often create mortgage boot by choosing less leverage without adding cash to compensate. The choice is more replacement debt or more cash in. A [replacement with less leverage](ltv-calculator-1031-debt-matching.html) needs that analysis, as does the broader question of how to [match your debt with new debt on the replacement](1031-exchange-equity-debt-matching.html).
...
- Cornell Legal Information Institute. [26 CFR § 1.1031(b)-1 — Receipt of other property or money (boot)](https://www.law.cornell.edu/cfr/text/26/1.1031(b)-1)
...
What part of the zero-boot calculation do you want your advisors to test before you commit to a replacement property?
