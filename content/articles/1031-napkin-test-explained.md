---
source_url: https://baker1031.com/learn/1031-napkin-test-explained/
source_sha256: d9dfaedf8ef549a13a8f609b35a5b368e1556bf9e9887a3aa0a6726695a52243
writer: writer-c
draft_version: 1
...
The napkin test is a rule of thumb for deciding whether a [1031 exchange](1031-exchange-guide.html) is likely to fully defer the gain. It compares two figures between the relinquished and replacement properties:
...
You can sketch those two lines on a napkin. If the replacement’s value and equity are each equal to or greater than the corresponding relinquished figures, the exchange generally points toward full deferral. If either line is lower, you have likely created [boot](insights.html).

This turns the [two core requirements for full deferral](1031-exchange-rules-requirements.html) into a quick screen. Acquire equal-or-greater replacement value. Reinvest all of your equity. A no on either point is a shortfall that can create boot.
...
- IRS, [Instructions for Form 8824 (realized and recognized gain)](https://www.irs.gov/forms-pubs/about-form-8824).
