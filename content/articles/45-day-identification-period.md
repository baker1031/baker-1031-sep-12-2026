---
source_url: https://baker1031.com/learn/45-day-identification-period/
source_sha256: db96ef7180fa8d0597c2a8f73eb5e0068707caa6896b5afe2b4527cbfbc81a20
writer: writer-b
draft_version: 1
...
Within 45 calendar days after selling the relinquished property, identify candidate replacements in a written notice, signed by you, and delivered to the [qualified intermediary](insights.html). The clock starts when title transfers to the buyer. It runs continuously through weekends and holidays and has no extension on request.
...
Use a legal description or a clear street address. “A fourplex in Austin” is not enough; name the exact property. For a [Delaware Statutory Trust](dst-guide.html), name the specific trust and the dollar amount or percentage interest. For an improvement or construction exchange, describe the improvements sufficiently to identify the completed property.
...
Most exchangers use the 3-property rule: one primary and one or two backups, regardless of value. Several DSTs can make the 200% rule practical. The 95% exception is a rare last resort with almost no room for error. The [dedicated identification-rules guide](1031-exchange-identification-rules.html) explains the limits in more depth.
...
The [45-day identification](1031-exchange-identification-rules.html) window is the first, decisive part of the concurrent 180-day exchange period. Identify on day 20 rather than day 44 and preserve 24 additional days to negotiate, finance, and close.
...
1. IRS, [Like-Kind Exchanges — identification rules](https://www.irs.gov/newsroom/the-treasury-department-and-irs-issue-final-regulations-regarding-like-kind-exchanges-of-real-property).
2. IPX1031, [1031 identification rules](https://www.irs.gov/forms-pubs/about-form-8824).
3. Accruit, [1031 Exchange identification and deadlines](https://www.accruit.com/blog/tax-day-2026-1031-exchange-reporting-deadlines-and-the-impact-of-h-r-1/).
4. Baker 1031 Investments, [The 1031 Exchange Timeline (Learning Center)](1031-exchange-timeline.html).
