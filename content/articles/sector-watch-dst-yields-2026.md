---
source_url: https://baker1031.com/learn/sector-watch-dst-yields-2026/
source_sha256: db03c85b537daea1cc713f0be2e71e2602e9ef1c712887c753ac3ed312d57dbd
writer: writer-b
draft_version: 1
...
**Market Data · Baker 1031 Research · Updated June 2026 · 12 min read**

I find a yield table useful only after I ask what the number is paying me to accept. The headline can be clear; the risk underneath it usually isn't.

First-order thinking ranks sectors by the current distribution. Second-order thinking asks what supports that cash flow, what can interrupt it, what growth is being given up, and how much of the risk is already priced into the quoted rate.

Going-in distributions vary widely by DST sector. Healthcare and net-lease tend to lead, multifamily and industrial sit in the middle, and office trails, a reflection of where income and risk are priced today.
...
The catch is that a net-lease distribution is only as good as the tenant behind it. With a single tenant on a long lease, the trust's income is concentrated in one credit. If that tenant is strong, the income is among the most dependable in real estate; if the tenant weakens or the location goes dark before the lease ends, there is no diversification to cushion it. So a higher net-lease distribution is not a free lunch, it is payment for taking concentrated tenant-credit risk in exchange for a long, predictable income stream. Diligence here is mostly diligence on the tenant, a theme our [sponsor due-diligence guide](dst-sponsor-due-diligence.html) develops further.
...
The risks are equally distinctive. The distribution rides on **commodity prices**, which swing far more than apartment or warehouse rents, so the income is volatile in a way real-estate rent is not. And the asset is subject to **depletion**: each barrel produced is gone, the reserve shrinks over time, and part of every distribution is effectively a return of a wasting asset rather than recurring income from a building that still stands. A higher minerals yield, then, compensates for commodity risk and depletion that real estate does not carry. We unpack the trade in detail in [why mineral royalties yield more](why-mineral-royalties-yield-more.html). The lesson for the sector table is simple: do not compare a minerals distribution to a net-lease distribution as if they measured the same thing.
...
| Sector | Typical current distribution | What drives it | Key risk |
| --- | --- | --- | --- |
| Healthcare / Medical Office | Among the highest | Aging demographics, sticky clinical tenants, high renewal rates | Operator credit, reimbursement trends, costly to re-tenant |
| Net Lease | Higher | Tenant pays expenses, long leases with scheduled bumps | Single-tenant credit concentration; vacancy hurts |
| Multifamily | Mid-range | Short leases that can reset rents up over time | Soft markets reset rents down; ongoing capex |
| Industrial | Mid-range | Longer leases, logistics demand, low capex | Tenant concentration and re-leasing in overbuilt markets |
| Self-Storage | Mid-to-upper | Low capex, many short leases, fast pricing power | Operationally intensive; demand softens when moves slow |
| Office | Lower | Depressed pricing can lift the quoted rate | Structural vacancy, heavy re-leasing capex, uncertain income |
| Minerals & Royalties | Among the highest | Revenue share with no operating costs or capital calls | Commodity-price swings and reserve depletion |
...
### Which DST sectors have the highest current distributions in 2026?

In general terms, healthcare and net-lease tend to lead the current-distribution ranking, with multifamily and industrial in the middle, self-storage holding the middle-to-upper part, and office trailing. Minerals and royalties often pay among the highest of all, but for very different, commodity-driven reasons. These are relative positions, not quotes of specific market rates.

### Why does office show a low distribution when its quoted rate sometimes looks high?

Office faces structural vacancy and heavy re-leasing costs, so its income is the least secure in the lineup. When pricing falls to reflect that risk, the quoted rate on a depressed price can look high, but it may not hold if a major tenant leaves and the building faces costly, uncertain re-leasing. A high quoted office yield is compensation for risk, not a bargain by default.

### Is a higher DST distribution always better?

No. A higher current distribution usually compensates for something: longer leases with concentrated tenant credit, more operational intensity, or commodity and depletion risk in the case of minerals. Current yield is also not total return, so a lower-distribution sector with strong rent growth can deliver more over a full cycle. The right choice depends on your goal and your risk tolerance, not the headline rate.

### Are DST distributions guaranteed?

No. Distributions are paid from property cash flow and can be reduced or suspended if a tenant goes dark, expenses rise, or the market softens. Part of a distribution can also be a return of your own capital rather than income the property earned, which means the headline rate can overstate the true economic yield in some offerings.

### Why do minerals and royalties pay more than building sectors?

A royalty owner receives a share of production revenue with no operating costs and no capital calls, so a large share of each dollar flows through, which supports a high payout. That yield compensates for commodity-price volatility and depletion, since each barrel produced shrinks the reserve. It is a different kind of income from a building's rent and should not be compared one-to-one.

### What should I check behind a sponsor's stated yield?

Confirm the rate is a current distribution on invested equity, not a total return or a guarantee. Check whether the property's net operating income covers it or whether reserves and financing are subsidizing it. Then look at the fees in front of the yield and how much of the distribution is return of capital versus property income. Two trusts can quote the same rate and mean very different things.

### How do interest rates affect DST yields in 2026?

The rate environment sets the backdrop. When financing is expensive and required yields are higher, sponsors generally offer more attractive going-in distributions to clear; when rates ease, going-in yields tend to compress as prices firm. That shifts the whole table up or down, while the relative order of the sectors stays broadly intact. Long-lease sectors are more rate-sensitive; short-lease sectors can reprice rents faster.

## Glossary

**Current Distribution Rate** — The annualized cash paid to investors, usually monthly or quarterly, divided by the amount invested; the headline yield, before any appreciation or sale.

**Going-In Yield** — The distribution rate at the start of an investment, before rent growth, refinancing, or disposition change the picture.

**Net Lease** — A lease in which the tenant pays property expenses such as taxes, insurance, and maintenance, so more of the rent reaches investors.

**Return of Capital** — A distribution that returns part of an investor's own invested principal rather than income earned by the property; it can carry useful tax characteristics but overstates the true yield if read as income.

**Cap Rate** — A property's net operating income divided by its price; a market-set yield measure that frames how sectors are priced and how going-in distributions move.

**Full-Cycle Return** — The total result of an investment measured from purchase to final sale, including distributions and the disposition, not just the income along the way.

**Total Return** — The combination of distributions collected and any change in the property's value through sale; the complete measure of performance, distinct from current yield.

**Depletion** — The gradual exhaustion of a mineral reserve as it is produced; because each unit extracted is gone, part of a royalty distribution effectively returns a wasting asset.

## Sources & References

- Baker 1031. [Baker 1031 Data Center — DST sponsor, offering, sector, and distribution data](insights.html)

- IRS. [IRS — Revenue Ruling 2004-86 (Delaware Statutory Trusts as 1031 replacement property)](https://www.irs.gov/pub/irs-drop/rr-04-86.pdf)
...
This article is published by Baker 1031 for general informational and educational purposes only. It is not investment, legal, or tax advice, and is not an offer to sell or a solicitation to buy any security. Distributions and yields vary by offering and over time; consult your own CPA and financial professional before acting.

Every figure and characterization here is general and illustrative, not a projection, a quote of current market rates, or a representation about any specific offering. DSTs and other private placements are speculative, illiquid securities sold only to verified accredited investors and involve substantial risk including loss of principal. Distributions are not guaranteed, may include a return of capital, and past performance does not guarantee future results.

I would treat the number in front of me as the beginning of the underwriting, not its conclusion: preserve liquidity, test the tenant and lease or the source of cash flow, and size the exposure for the downside that can arrive before the income does. What are you asking behind the headline yield before you commit capital?
