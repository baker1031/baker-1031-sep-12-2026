---
source_url: "https://baker1031.com/learn/1031-exchange-timeline/"
source_sha256: "489b759cb649290db7d518787abad744fe6e515c6657c2960c8b26a827434d89"
writer: "writer-c"
draft_version: "1.0"
...
That is difficult but controllable risk. The relevant question is not merely whether a replacement exists. It is whether a suitable replacement, the financing, and the written process will be ready on the dates that matter. For the wider rule set, see the [1031 exchange guide](1031-exchange-guide.html).
...
If several relinquished properties are sold in one exchange, the clock generally begins at the **earliest** transfer. Staggered closings can quietly consume the time available for everything else. Because Day 0 controls both clocks, engaging the [qualified intermediary](1031-exchange-guide.html), building a replacement list, and arranging financing should be underway before closing. At the sale, a person who has not prepared is already behind.
...
There is one useful nuance. Under the incidental-property rule, items that come with a larger property—such as appliances or furnishings—and are worth no more than 15% of that property's value generally do not need separate identification. The 200% rule can help a portfolio-minded investor, but the aggregate value ceiling needs careful attention. Our [identification rules memo](1031-exchange-identification-rules.html) addresses the subject in greater depth.
...
The result is binary. Miss the 45-day deadline and new property generally cannot be named; without a valid identification, there is nothing to acquire. Miss the 180-day closing deadline and the exchange also fails. In either case, the sale is fully taxable for that year: capital gains, [depreciation recapture](1031-exchange-boot.html), net investment income tax, and state tax come due as if no exchange had been attempted. There is no partial credit for trying. Other than the disaster relief noted above, preparation is the protection.

## Planning to never miss

The investors who avoid timing problems tend to complete five tasks before sale:

1. **Engage the qualified intermediary early** so proceeds are handled correctly from the sale forward.
2. **Begin the replacement search before closing** so the 45-day period is not spent starting from scratch.
3. **Arrange financing in advance** because a slow loan is the most common reason a closing slips past Day 180.
4. **Identify a backup.** Many investors name a [Delaware Statutory Trust](1031-exchange-into-dst.html) as one of three replacements because it can close in days when a primary deal collapses.
5. **Extend the tax return** for a late-year sale to preserve the full 180 days.
...
A pre-identified, fast-closing [Delaware Statutory Trust](dst-guide.html) can be the strongest timeline protection. The DST property is already acquired and its structure is in place, so it can close in a few business days.
...
Match the new debt to equal-or-greater-value and debt-replacement rules. The new loan generally must be at least as large as the debt paid off, or mortgage [boot](1031-exchange-boot.html) can result. A leveraged DST has pre-arranged, non-recourse debt, so there is no loan application to delay the purchase.
...
1. Treasury Regulation, [26 CFR §1.1031(k)-1](https://www.law.cornell.edu/cfr/text/26/1.1031(k)-1) — the deferred-exchange rules that establish the 45-day identification window, the 180-day closing deadline (capped at the tax-return due date), the three-property / 200% / 95% identification rules, and the requirement to deliver a signed identification to the qualified intermediary.
2. Internal Revenue Code, [26 U.S.C. §1031](https://www.law.cornell.edu/uscode/text/26/1031) — the like-kind exchange statute these deadlines hang off of, and the source of the rule that a missed deadline makes the sale fully taxable.
3. IRS, [Like-Kind Exchanges — Real Estate Tax Tips](https://www.irs.gov/forms-pubs/about-form-8824) — the IRS plain-language overview confirming the 45-day and 180-day periods and the role of the qualified intermediary.
4. IRS, [Form 8824, Like-Kind Exchanges](https://www.irs.gov/forms-pubs/about-form-8824) — the form on which the exchange and its identification and closing dates are reported.
...
For now, a sensible capital-management stance is to have the intermediary, candidate list, financing, and backup prepared before the sale closes—not to stretch a deadline because a deal looks attractive. Where does the clock create the greatest risk in your exchange? If that question is live for you right now, send it over and I will work through it with you.
