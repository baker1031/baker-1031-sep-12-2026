---
source_url: https://baker1031.com/learn/who-should-not-do-a-721-exchange/
source_sha256: 11f6b835b296e86f25c5ae3a188698d954813c8c3b9973345c04cfc520c56f22
writer: writer-c
draft_version: 1
...
I keep noticing that a strong tax feature can crowd out a simple suitability question: should this investor use it at all? First-order thinking asks what a 721 can defer. Second-order thinking asks what it gives up—control, near-term liquidity, future 1031 flexibility, and the ability to reverse course—and whether those costs fit the person making the choice.
...
An investor who needs near-term liquidity should NOT do a 721 exchange, because the strategy is illiquid in the near term. After a 721 exchange, you hold [OP units](op-units-explained.html), which have a lock-up period before you can convert them to shares (often around a year), and accessing liquidity (converting and selling) triggers tax — so the liquidity isn't immediate or free. So if you need cash soon after the exchange, the 721 can't readily provide it.
...
- **Disqualifying Profile:** A type of investor for whom the 721 exchange is a poor fit.

- **Active Investor:** One who values controlling their real estate, unsuited to the 721.

- **Control:** Decision-making over real estate, given up in the 721.

- **Near-Term Liquidity:** Cash needed soon, incompatible with the illiquid 721.

- **Lock-Up Period:** The wait before converting units, a near-term illiquidity factor.

- **1031 Flexibility:** The ability to keep exchanging, foreclosed by the 721.

- **One-Way Nature:** The 721's irreversibility, unsuited to flexibility-wanting investors.

- **Commitment:** The readiness needed for the irreversible 721, lacking in the uncertain.

- **Irreversibility:** The 721's permanence, requiring certainty.

- **Accredited Investor:** The status required; non-accredited investors can't access it.

- **Suitability Review:** The assessment identifying when the 721 is inappropriate.

- **Unsuitable Investor:** One for whom the 721 doesn't fit, who shouldn't do it.

- **1031 Exchange:** The better-fitting alternative for control/flexibility investors.

- **Better-Fitting Alternative:** The strategy suited to those who shouldn't do a 721.

- **Poor-Fit Commitment:** A regretted 721 by a disqualified-profile investor.

- **Honest Self-Assessment:** Recognizing if you're in a disqualifying profile.
...
- FINRA. [Suitability and Know Your Customer Obligations](https://www.finra.org/rules-guidance/key-topics/suitability)

- U.S. Securities and Exchange Commission. [Investor.gov — Accredited Investors](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/updated-3)
...
For capital, I would favor fit over tax deferral: retain liquidity, control, or 1031 flexibility where those needs are real, and use a 721 only when its long-term tradeoffs are acceptable. What condition would make you decide that this is not the right path?
