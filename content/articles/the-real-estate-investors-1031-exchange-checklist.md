---
source_url: https://baker1031.com/learn/the-real-estate-investors-1031-exchange-checklist/
source_sha256: ba3a4c2a2ecb0dc56349c380eae9b4877afd8bf058f9ae19b006a9ae2b67d25f
writer: batch-036-writer-b
draft_version: 1
source_unit_count: 143
risk: "dst"
---
...
I keep seeing investors focus on the replacement property while the quieter risks gather before the sale even closes. A 1031 exchange rarely breaks because of a single complicated document; it breaks because a sequence was treated as a series of optional errands.

First-order thinking says the job is to find a replacement property. Second-order thinking starts earlier: protect control of the proceeds, prepare for hard deadlines, and leave room for a primary plan to fail without taking the exchange with it.
...
The most important phase of a [1031 exchange](1031-exchange-guide.html) happens before you list the property for sale, because it's the only time you fully control the timeline. Start by confirming the exchange makes sense: with your CPA, [estimate the four-layer tax you'd defer on the sale](capital-gains-tax-calculator-property-sales.html) and confirm an exchange fits your goals (versus paying the tax or another strategy). Then confirm the property qualifies — that it's been held for investment — and that you intend to reinvest in like-kind real estate. These threshold decisions shape everything that follows.

Next, assemble your team and your strategy before listing. Engage (or line up) a [qualified intermediary](what-is-a-qualified-intermediary.html), loop in your CPA, and bring in an advisor to help with replacement property. Decide your replacement strategy: what kind of property you want (active or passive, what type, what markets), and begin building a shortlist of candidates — including a fast-closing backup like a DST. Because the 45-day clock starts at closing, having candidates and a strategy ready before you sell turns the identification window into a confirmation step rather than a frantic search.
...
Closing on the replacement must happen within 180 days, with the QI using the escrowed proceeds to fund the purchase. You can only acquire property you actually identified — no substituting a new find on day 100. To fully defer, the value and debt math must work: acquire replacement property of equal or greater value than the net sale price, reinvest all your equity, and replace any debt you paid off (with new financing, added cash, or a leveraged DST's built-in debt). Any cash kept or value not replaced is taxable [boot](what-is-boot-1031-exchange-how-to-avoid.html).
