---
source_url: https://baker1031.com/learn/dst-properties-whats-available-and-how-to-browse-offerings/
source_sha256: 5267058c98c5e436a5b74e0d63da7b72e291a973b6bfb649b7da13fbe952d26f
writer: writer-b
draft_version: 1
...
[Home](baker1031.html) › Insights › DST Properties: What's Available and How to Browse Offerings
...
What kinds of properties are available as DSTs, and how do you browse them? This guide covers the common asset classes, all-cash/debt-free versus leveraged structures, current-offering access, offering summaries, comparisons, and requesting the full property list. Individual DST securities change as offerings open and fill, and they cannot be publicly promoted with promised returns. DST interests are securities offered to accredited investors after suitability review. Verify current availability, tax treatment, and exchange facts with your advisor, CPA, and, where applicable, [qualified intermediary](what-is-a-qualified-intermediary.html). This is educational information, not advice.

Browsing becomes more useful after reading [the full guide to DST investing](dst-guide.html).
...
An all-cash or debt-free DST owns property without a mortgage. It avoids financing risk, interest-rate exposure on debt, and lender-foreclosure risk. The trade-off is exchange math: an investor who paid off debt on a relinquished property can have [boot](what-is-boot-1031-exchange-how-to-avoid.html) unless that debt is replaced or covered another way.
...
- An investor browses current offerings through a broker-dealer after confirming [accredited investor](accredited-investor-requirements.html) status, with filters tied to exchange parameters.
...
1. U.S. Securities and Exchange Commission. [Investor.gov — Updated Investor Bulletin: Accredited Investors](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/updated-3)
...
I am managing the risk here by treating current availability and the PPM as inputs, not by reaching for a sector label or projected rate. What facts are you putting first when you compare replacement-property options?
