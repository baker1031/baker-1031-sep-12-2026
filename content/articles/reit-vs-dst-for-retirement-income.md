---
source_url: https://baker1031.com/learn/reit-vs-dst-for-retirement-income/
source_sha256: c25c903dc52ed84fcdecfcef55a9c730b0e13317c91894902afc69f8137edab6
writer: writer-a
draft_version: 1
...
# REIT vs. DST for Retirement Income: Which Funds Decumulation Better?
...
I keep seeing retirement-income choices reduced to yield, even though retirees have to live with the path as well as the payment. A higher number on a statement cannot answer whether capital will be available when it is needed or whether an embedded gain is being surrendered too early.

In the drawdown years the question isn't just "which yields more" — it's which produces a steadier, more durable check, how each handles sequence-of-returns and inflation risk, and whether you can turn an appreciated property into retirement income without a tax hit. This guide weighs REIT dividends against DST distributions through the lens of a decumulation plan.

The first-order view is straightforward: compare the headline yield or distribution. The second-order view is tougher: ask how the cash flow, liquidity, tax position, and sequence of returns behave when a retirement plan is under stress.

Retirement changes the question. During the accumulation years you care about total return; in **decumulation** — the drawdown phase — what matters is whether the income arrives reliably, holds up against inflation, and survives a bad market early in retirement (the "sequence-of-returns" problem). REITs and Delaware Statutory Trusts (DSTs) answer that question differently. A traded REIT pays dividends you can rely on month to month but whose *share price* swings with the market, so selling shares for income in a down year locks in losses. A DST pays a defined-term distribution from a specific property pool, insulated from daily price marks, but with no liquidity to draw on mid-hold. And for the retiree who is funding all of this by selling an appreciated rental, only the DST can do so without triggering the capital-gains tax. For the full structural side-by-side of how the two vehicles differ, see our [DST vs. REIT comparison](dst-vs-reit.html); this guide focuses specifically on which one builds a more durable retirement paycheck. Baker 1031 does not provide tax or legal advice — this is educational information; verify the current rules and your situation with your tax advisor.
...
So liquidity versus tax deferral is the central trade-off: a publicly traded REIT offers liquidity but no 1031 deferral (selling appreciated property to buy REIT shares is taxable), while a DST offers 1031 tax deferral but is illiquid for the multi-year hold. For a retiree, this comes down to whether accessing capital easily matters more than deferring the tax on an appreciated property's gain. The REIT wins on flexibility; the DST wins on deferral. Many investors weigh how large the embedded gain is, how much liquidity they need, and whether deferral materially improves their retirement plan. A traded REIT offers liquidity but no 1031 deferral; a DST is illiquid but 1031-eligible, deferring the gain on an appreciated property.

The central retirement trade-off: a REIT gives you liquidity but no deferral, while a DST defers the tax on an appreciated property's gain in exchange for locking up your capital for years.

## Funding Retirement From an Appreciated Property

Many retirees aren't deploying fresh cash — they're converting a long-held rental into a retirement paycheck. Here the 1031 distinction becomes a retirement-planning decision, not just a tax footnote. Because a DST interest is treated as like-kind real property (under IRS Revenue Ruling 2004-86), you can [1031-exchange](1031-exchange-guide.html) the sale proceeds into a DST and start drawing income on the *whole* pre-tax amount, deferring the capital-gains tax and depreciation recapture you'd otherwise pay. Buy a REIT instead and you must sell the property first, pay the tax, and live off income generated by the smaller after-tax balance — a permanent reduction in the capital base your retirement income is drawn from. For a retiree with a large embedded gain, that difference can be the equivalent of several years of distributions. (A 1031-into-DST-then-721-into-REIT path can later bridge to REIT exposure with deferral intact; for the mechanics of that two-step move and the full structural comparison, see [DST vs. REIT](dst-vs-reit.html).)
...
## Income Now, Legacy Later: The Decumulation Endgame

A good retirement-income plan also has an endgame, and this is where the two vehicles diverge for heirs. If you fund retirement income through a DST acquired in a 1031 exchange and hold it (or keep exchanging) until death, your heirs generally receive a [step-up in basis](1031-exchange-step-up-in-basis-at-death.html) that can erase the deferred property gain entirely — you collected income for years *and* the original tax bill disappears. REIT shares also get a step-up at death on their own appreciation, but a REIT-funded plan already paid the property-sale tax upfront, shrinking the income base for the whole of retirement. So for a retiree who wants to draw income now and pass real estate wealth efficiently later, the DST's combination of deferral-plus-step-up is the more tax-efficient drawdown vehicle; the REIT trades that away for liquidity. (This estate-planning interaction is covered in depth in the canonical [DST vs. REIT comparison](dst-vs-reit.html).) This is educational content, not tax or legal advice.
...
**REIT:** A company that owns or finances real estate and pays dividends.

**Delaware Statutory Trust (DST):** 1031-eligible fractional real estate offering passive income.

**1031 Exchange:** A like-kind exchange that defers capital-gains tax on real property.

**1031 Eligibility:** Qualifying as like-kind real property (DSTs yes, REIT shares no).

**Tax Deferral:** Postponing capital-gains tax via a 1031 exchange.

**Step-Up in Basis:** Resetting an asset's basis to fair market value at death.

**Swap Till You Drop:** Exchanging until death so the step-up erases the deferred gain.

**721 / UPREIT Exchange:** Contributing property to a REIT for OP units, preserving deferral.

**Operating-Partnership Units:** Interests received in a 721 exchange, convertible to REIT shares.
...
**Depreciation:** A deduction that can shelter some DST rental income.

**Hold Period:** The roughly five-to-seven-year term of a typical DST.

**Liquidity:** The ability to sell and access your capital readily.

**Illiquidity:** The inability to easily exit a DST during its hold.

**Publicly Traded REIT:** An exchange-listed, liquid, dividend-paying REIT.
...
## REIT vs. DST for retirement income at a glance

How REITs and DSTs compare specifically for funding retirement and decumulation:

| Factor | REIT | DST |
| --- | --- | --- |
| Income | Dividends, mostly ordinary income | Pass-through rent, sheltered by depreciation |
| Tax deferral on funding | No 1031 from an appreciated property | Yes — 1031 of a relinquished property |
| Liquidity | Public: daily; non-traded: limited | Illiquid; finite hold |
| Predictability | Market-priced; dividends can vary | Defined hold; distributions per the offering |
| Step-up at death | Yes (on shares) | Yes (on the interest) |
| Decumulation fit | Easy to draw down in pieces | Income now; full-cycle event later |

## Which should you choose?

If you are funding retirement from an appreciated property, the DST lets you defer the gain on the way in and convert it into depreciation-sheltered passive income — a head start a REIT purchase can't match.

A REIT suits retirement cash you can invest directly and want to draw down flexibly. Many retirees use both: a DST for the exchanged property, then a 721 roll-up into a REIT later for liquidity and easier estate division.
