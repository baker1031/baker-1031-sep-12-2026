---
source_url: "https://baker1031.com/learn/using-dsts-as-backups-in-your-1031-identification/"
source_sha256: "fb364201c66d4a8cc2cad2fc3629bff907f2b990ddaf148c6d7ef0cffd867697"
writer: "writer-b"
draft_version: "1"
...
# Using DSTs as Backups in Your 1031 Identification

**Delaware Statutory Trusts · Baker 1031 Research · Updated June 2026 · 16 min read**

[Back to All Insights](insights.html)

I keep coming back to the same practical question in a 1031 exchange: what happens if the deal everyone expects to close does not close?

The first-order view is to focus on the property in front of you and assume the deadline will take care of itself. The second-order view is to recognize that the 45-day and 180-day rules leave very little room to recover from a broken primary deal. A backup is not a prediction that a deal will fail. It is a way to keep one failure from deciding the entire exchange.
...
So a DST backup turns a fragile exchange into a resilient one. How DSTs serve as reliable backups — being pre-packaged (already assembled with property, financing, and documents ready), generally available across asset classes, and fast to close (often within days, with no purchase negotiation) — makes them ideal fallbacks when a primary replacement deal fails late in the 45-to-180-day window. Their speed and availability rescue exchanges on short notice. DSTs are reliable backups because they're pre-packaged, available, and close in days, so they can rescue an exchange when a primary deal fails near the deadline.
...
So the QI is your essential partner in the backup strategy. Coordinating with your QI — delivering an unambiguous written identification of the primary and DST backups by day 45, keeping the QI informed of the primary deal's status, and orchestrating the direct funding wire (proceeds must never touch your hands) before day 180 among you, the QI, the DST broker-dealer, and your CPA — is what executes a backup cleanly. The QI holds the funds and receives the IDs. Coordinate with your QI to get the day-45 identification right, keep the QI updated, and orchestrate the direct funding wire before day 180 — the QI must fund the DST directly to preserve the exchange.
...
Reviewed by
 ...
 [Lori Kamen](https://brokercheck.finra.org/individual/summary/2805591) — President & CCO, Aurora Securities, Inc. (FINRA Series 4 / 7 / 24 / 53 / 63 / 66), the supervising registered principal. Last reviewed June 2026. Baker 1031 reviews its educational content periodically for accuracy and regulatory compliance.
...
The practical stance is simple: plan the backup while there is still time to choose it, confirm the rules with the qualified intermediary, CPA, and attorney, and treat suitability, liquidity, and the strict calendar as real constraints. A DST can be useful when suitable, but it does not remove those constraints or guarantee an outcome. How are you building room for a primary deal to fail without putting the whole exchange at risk?
