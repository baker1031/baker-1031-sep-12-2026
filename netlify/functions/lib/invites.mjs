...
<tr><td style="padding:22px 0 18px 0"><a href="https://baker1031.com" rel="noopener noreferrer" style="text-decoration:none;border:0" target="_blank"><img src="https://baker1031.com/assets/img/logo.png" alt="Baker 1031 Investments" width="200" height="38" style="display:block;width:200px;height:38px;border:0;outline:none;text-decoration:none"></a></td></tr>
