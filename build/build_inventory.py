...
''' + badgecss + r'''
  ...
  .range__scale{ display:flex; justify-content:space-between; font-size:11.5px; color:rgba(0,0,0,.55); margin-top:4px; }
  ...
  .card__media{ position:relative; aspect-ratio:4 / 3; background:#FCF7F0; border-radius:var(--radius) var(--radius) 0 0; overflow:hidden; }
  ...
  .status--sold::before{ background:rgba(0,0,0,.55); }
  ...
  .tip__box{
    ...
    padding:12px 14px; background:#000000; color:#FCF7F0; border-radius:6px;
  ...
  .tip__box::before{ content:""; position:absolute; right:18px; top:-6px; border-left:6px solid transparent; border-right:6px solid transparent; border-bottom:6px solid #000000; }
  .tip__box strong{ display:block; margin-bottom:3px; color:#fff; }
  .tip__box small{ display:block; margin-top:6px; font-size:11px; color:rgba(0,0,0,.55); }
  ...
  .card__stats div{ display:flex; justify-content:space-between; align-items:baseline; gap:12px; padding:7px 0; border-bottom:1px solid #FCF7F0; }
  ...
  .inv__index{ margin:40px 0 0; font-size:12.5px; line-height:1.9; color:rgba(0,0,0,.6); }
  .inv__index-label{ margin:0 0 4px; font-size:11px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:rgba(0,0,0,.6); }
  .inv__index a{ color:#000000; text-decoration:none; }
  .inv__index a:hover{ color:var(--accent-text); text-decoration:underline; }
  .inv__disclosure{ margin:24px 0 0; font-size:11px; line-height:1.6; color:rgba(0,0,0,.6); }
  ...
  .gate__card{ background:var(--white); border:1px solid var(--hair-strong); border-radius:10px; padding:26px 30px 24px; box-shadow:0 26px 52px -28px rgba(0,0,0,.24), 0 1px 3px rgba(0,0,0,.05); }
