...
''' + badgecss + r'''
  ...
  .select:focus{ border-color:var(--accent); box-shadow:0 0 0 3px rgba(76,0,24,.18); }
  ...
  .check input:focus-visible ~ .check__box{ box-shadow:0 0 0 3px rgba(76,0,24,.25); }
  .check input:checked ~ .check__text{ color:var(--black); }
  .check__count{ margin-left:auto; font-size:12px; color:#6E6765; }
  ...
  .range__scale{ display:flex; justify-content:space-between; font-size:11.5px; color:#6E6765; margin-top:4px; }
  ...
  .card__media{ position:relative; aspect-ratio:4 / 3; background:#F1ECE6; border-radius:var(--radius) var(--radius) 0 0; overflow:hidden; }
  ...
  .status--sold::before{ background:#6E6765; }
  ...
  .tip__box{
    ...
    padding:12px 14px; background:#211E1E; color:#FAF8F5; border-radius:6px;
  ...
  .tip__box::before{ content:""; position:absolute; right:18px; top:-6px; border-left:6px solid transparent; border-right:6px solid transparent; border-bottom:6px solid #211E1E; }
  .tip__box strong{ display:block; margin-bottom:3px; color:#fff; }
  .tip__box small{ display:block; margin-top:6px; font-size:11px; color:#6E6765; }
  ...
  .card__stats div{ display:flex; justify-content:space-between; align-items:baseline; gap:12px; padding:7px 0; border-bottom:1px solid #F1ECE6; }
  ...
  .inv__index{ margin:40px 0 0; font-size:12.5px; line-height:1.9; color:#645D5B; max-width:1100px; }
  .inv__index-label{ margin:0 0 4px; font-size:11px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:#645D5B; }
  .inv__index a{ color:#4A4444; text-decoration:none; }
  .inv__index a:hover{ color:var(--accent); text-decoration:underline; }
  .inv__disclosure{ margin:24px 0 0; font-size:11px; line-height:1.55; color:#645D5B; max-width:900px; }
